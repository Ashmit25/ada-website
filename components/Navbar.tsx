    ...
    <>
      <div className="flex flex-row justify-between p-8 items-center mx-3">
        ...
        <div className="block sm:hidden">
          ...
          {showMobile && (
            <div className="z-[2] bg-[#2977f5bf] text-white fixed top-0 left-0 right-0 h-screen flex flex-col items-center justify-center gap-8">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="fixed right-11 top-[57px] z-[2] h-6 w-6 inline-block lg:hidden cursor-pointer"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
