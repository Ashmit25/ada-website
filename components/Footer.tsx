export default function Footer() {
  return (
    <footer className="flex flex-col items-center justify-center px-2 py-4 mt-2 text-sm text-center border-t text-accent sm:text-xs border-accent/30 text-[#595959]">
      ...
      <div className="text-[13px]">
        &copy; {new Date().getFullYear()}-{(new Date().getFullYear() + 1) % 100}{" "}
        Exun Clan and DPS RK Puram, New Delhi, India
      </div>
    </footer>
  );
}
